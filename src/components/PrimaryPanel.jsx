...
const PrimaryPanel = ({ isCollapsed, onToggleCollapse, toggleBehavior = 'shrink' }) => {
  ...
  if (isCollapsed) {
    if (toggleBehavior === 'shrink') {
      ...
      return (
        <aside className="w-16 bg-gray-800/80 backdrop-blur-sm border-r border-gray-700/50 text-white transition-all duration-300 flex flex-col relative z-10">
      ...
      return (
        <aside className="w-2 bg-gray-800/80 backdrop-blur-sm border-r border-gray-700/50 text-white relative z-10 flex flex-col group hover:w-8 transition-all duration-200">
  ...
  return (
    <aside className="w-80 bg-gray-800/80 backdrop-blur-sm border-r border-gray-700/50 text-white transition-all duration-300 flex flex-col relative z-10">
      ...
      {/* Content - Always show when not collapsed */}
      {/* Quick Actions */}
      <div className="p-4 border-b border-gray-700/50">
