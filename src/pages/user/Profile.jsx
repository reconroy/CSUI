        ...
        <div className="space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              ...
              <p className="mt-1 text-gray-900">
                <a href={`https://github.com/${profile.github}`} className="text-indigo-600 hover:text-indigo-500" target="_blank" rel="noopener noreferrer">
                  @{profile.github}
                </a>
              </p>
            </div>
            ...
            <div>
              ...
              <p className="mt-1 text-gray-900">
                <a href={`https://twitter.com/${profile.twitter}`} className="text-indigo-600 hover:text-indigo-500" target="_blank" rel="noopener noreferrer">
                  @{profile.twitter}
                </a>
              </p>
            </div>
