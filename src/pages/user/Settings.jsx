  ...
  return (
    <div className="bg-white shadow rounded-lg p-6">
      ...
      <form onSubmit={handleSubmit}>
        ...
        <div className="mb-8">
          <h3 className="text-lg font-medium text-gray-800 mb-4">Code Editor</h3>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
            ...
            <div>
              <label htmlFor="tabSize" className="block text-sm font-medium text-gray-700 mb-1">Tab Size</label>
              <select
                id="tabSize"
                name="tabSize"
            ...
            <div className="flex items-center">
              <input
                ...
                className="h-4 w-4 text-indigo-600 focus:ring-indigo-500 border-gray-300 rounded"
              />
              <label htmlFor="wordWrap" className="ml-2 block text-sm text-gray-700">
                Word Wrap
              </label>
            </div>
          </div>
